...
public class Produto implements Serializable{
	 ...
	 * IDENTITY: id gerado pela coluna de auto incremento da tabela, porém nem todos os bancos suportam essa opção
	 * SEQUENCE: valor gerado por uma sequencia, que se não for especificada, será global gerada pelo banco, para todas as entidades.
	 * TABLE: é necessário criar uma tabela para gerenciar as chaves primárias. Essa opção não é recomendada.
	 */
	private Long id;
...
/*	
	@Lob // large Object Blob -> Objeto estranho para o sistema: arquivo, imagem, arquivo de áudio.
	private byte[] teste;
*/	
	...
	public String toString() {
		return String.format("ID: %-5d Descrição: %-30s Preço: R$ %-10.2f Quantidade: %-5d", id, descricao,  preco, quantidade);
	}
